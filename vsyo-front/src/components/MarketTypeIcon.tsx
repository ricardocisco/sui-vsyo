...
export function MarketTypeIcon({ type, className = "w-5 h-5" }: MarketTypeIconProps) {
      ...
      case "Politics":
        return (
          <svg viewBox="0 0 24 24" fill="none" className={className}>
            ...
            {/* Strike face */}
            <rect x="5" y="5" width="10" height="2" rx="0.5" fill="currentColor" opacity="0.8" />
            {/* Base */}
      ...
      case "Tech":
        return (
          <svg viewBox="0 0 24 24" fill="none" className={className}>
            ...
            <rect x="7" y="8" width="10" height="6" rx="0.5" fill="white" opacity="0.2" />
            <rect x="9" y="16" width="6" height="1" rx="0.5" fill="currentColor" />
            <rect x="10" y="17" width="4" height="0.5" rx="0.25" fill="currentColor" opacity="0.6" />
            <circle cx="9" cy="10" r="0.5" fill="white" />
            <path d="M11 10H13" stroke="white" strokeWidth="1" strokeLinecap="round" />
          </svg>
        );
      case "Geopolitics":
        return (
          <svg viewBox="0 0 24 24" fill="none" className={className}>
            ...
            <circle cx="12" cy="12" r="10" fill="currentColor" opacity="0.1" />
            <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.5" fill="none" />
            <ellipse cx="12" cy="12" rx="9" ry="4" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.5" />
      ...
      case "Earnings":
        return (
          <svg viewBox="0 0 24 24" fill="none" className={className}>
            ...
            <path d="M18 12L20 8" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        );
      case "Culture":
        return (
          <svg viewBox="0 0 24 24" fill="none" className={className}>
            ...
            <path d="M10 11C10 11 11 12 12 12C13 12 14 11 14 11" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
            <path d="M10 13C10 13 11 14 12 14C13 14 14 13 14 13" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
        );
      case "World":
        return (
          <svg viewBox="0 0 24 24" fill="none" className={className}>
            ...
            <circle cx="12" cy="12" r="10" fill="currentColor" opacity="0.1" />
            <circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.5" fill="none" />
            <ellipse cx="12" cy="12" rx="9" ry="4" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.4" />
            <ellipse cx="12" cy="12" rx="4" ry="9" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.4" />
            <path
      ...
      case "Climate & Science":
        return (
          <svg viewBox="0 0 24 24" fill="none" className={className}>
            {/* Atom/Molecule */}
            <circle cx="12" cy="12" r="10" fill="currentColor" opacity="0.1" />
            <ellipse cx="12" cy="12" rx="8" ry="3" stroke="currentColor" strokeWidth="1.5" fill="none" transform="rotate(45 12 12)" />
            <ellipse cx="12" cy="12" rx="8" ry="3" stroke="currentColor" strokeWidth="1.5" fill="none" transform="rotate(-45 12 12)" />
            <circle cx="12" cy="12" r="2" fill="currentColor" />
      ...
      case "Elections":
        return (
          <svg viewBox="0 0 24 24" fill="none" className={className}>
            ...
            <rect x="8" y="7" width="8" height="10" rx="0.5" fill="white" opacity="0.2" />
            ...
            <path d="M12 4L13 6L15 5L14 7L16 7L14 8L15 10L13 9L12 11L11 9L9 10L10 8L8 7L10 7L9 5L11 6L12 4Z" fill="currentColor" />
          </svg>
        );
      case "Breaking":
        return (
